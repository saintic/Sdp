...
email() {
  ...
  tail $init_user_home_info | mail -s "欢迎您，$init_user" -r SdpCenter@saintic.com $user_email
  tail -20 $Sdpuc | head -19 | mail -s "Sdpv1.UserInfo:${init_user}(UID:${user_id})" -r SdpCenter@saintic.com $admin_email
}
